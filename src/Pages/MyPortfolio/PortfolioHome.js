...
import person1 from "../../assets/portFolioImg/person1.png";
        ...
        <div className="lg:w-4/5 mx-auto flex flex-wrap">
          ...
          <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
            ...
            <p className="leading-relaxed">
              I'm a 22 years old boy with a passion for technology, xianxia
            ...
            <p>
              I have no professional experience so far If you have any
              interesting projects that involve my skills, feel free to contact
              me!
            </p>
            <div>
              <div className="pt-2">
                <h3 className="text-xl font-medium">Html css</h3>
                <progress
