...
const Blog = () => {
  return (
    <section class="text-gray-800 bg-gray-100 body-font">
      <div class="container px-5 py-12 mx-auto">
        <div class="flex flex-wrap -m-4">
          <div class="pl-4 md:w-1/2 w-full">
            <div class="h-full bg-gray-100 p-8 rounded">
              ...
              <p class="leading-relaxed mb-3">
                ...
                will collect all props and redistribute them to other
                components.
              </p>
            </div>
          </div>
          <div class="pl-4 md:w-1/2 w-full">
            <div class="h-full bg-gray-100 p-8 rounded">
              ...
              <p class="leading-relaxed mb-3">
                ...
                component.There are several other ways to manage state's in
                React, including the use of: <b>Hooks React</b><b> Context API</b> <b>Apollo Link
                State</b>
              </p>
            </div>
          </div>
